...
SET @EnvironmentId 			= '0CC710DF-BDAC-4D23-9D2A-168EC908A474'
SET @BusinessFlow  			= NULL
SET @ExecPath	   			= NULL
SET @CompletedInvoiceOnly  	= 1      
SET @GenerateRemitedAdvises = 0  
SET @NoOfDaysPrior 		    = 0 
SET @CheckDateToUse			= 'InPaymentNew' --InvoiceDueDate, InvoiceCreateDate, ForwardDate, ExecutionDate, InPaymentNew
